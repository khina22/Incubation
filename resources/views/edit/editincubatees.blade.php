...
<form action="/update_incubatees" method="POST" enctype="multipart/form-data" class="my-form">
        <h2>Edit Incubatees</h2>
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="tel" id="contact_no" name="contact_no" class="form-control" value="{{$data->contact_no}}" required>
    </div>
